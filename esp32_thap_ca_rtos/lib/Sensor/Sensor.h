...
class Sensors
{
  public:
     ...
     */
    Sensors(uint32_t pin1, uint32_t pin2, uint16_t Vol1 = 5000, uint16_t Vol2 = 3300, uint16_t Resol = 4096);
     ...
     */
    void Set_Vref(uint16_t V_new1 = 5000, uint16_t V_new2 = 3300);
     ...
     */
    void Set_Resolution(uint16_t Res_new = 4096);
